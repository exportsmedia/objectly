<div class="flex items-center justify-between h-full px-8 mx-auto text-purple-600 dark:text-purple-300">
    <!-- Mobile hamburger -->
    <button class="p-1 mr-5 -ml-1 rounded-md lg:hidden focus:outline-none focus:shadow-outline-purple"
        @click="isOpen = !isOpen" aria-label="Menu" :class="{ 'transition transform-180': isOpen }">
    ...
    <ul class="flex items-center flex-shrink-0 space-x-6">
        ...
        <li class="relative">
            <button class="relative align-middle rounded-md focus:outline-none focus:shadow-outline-purple"
                ...
                <!-- Notification badge --><span aria-hidden="true"
